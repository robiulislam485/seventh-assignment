...
const SelectedPlayers = ({selectedPlayer,handleDelete,activeHandler}) => {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-3 mb-80">
                    ...
                    <div className="flex justify-between items-center ">
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Price: ${player.price}</p>
                            </div>
                        </div>
            ...
            <button onClick={()=>activeHandler(false)} className="bg-[#E7FE29] px-4 py-2 rounded-md text-black font-semibold">Add More Player</button>
        </div>
    );
};

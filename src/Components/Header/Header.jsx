        ...
        <div className="max-w-7xl mx-auto mt-8 mb-6">
            <nav className="flex justify-between items-center">
                ...
                <div>
                    <ul className="flex gap-12 items-center text-gray-500">
                        ...
                        <p className="px-7 py-2 border-2 rounded-lg shadow-sm flex items-center gap-2"> {coin} Coin <img src="./public/assets/coin.png" alt="" /></p>
                    </ul>
                </div>
            </nav>   
            ...
            <div className={`max-w-7xl mx-auto  justify-center bg-no-repeat bg-cover bg-center rounded-lg mt-6 space-y-6 brightness-90`}
                ...
                <div className="flex flex-col items center text-center justify-center p-14 space-y-6">
                    <img className="w-52 mx-auto" src="./public/assets/banner-main.png" alt="" />
